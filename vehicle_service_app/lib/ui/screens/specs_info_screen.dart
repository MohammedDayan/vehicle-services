                    ...
                    child: TextFormField(
                     /* initialValue: widget.user.email,
                      ...
                      validator: (val) =>
                          val.contains('@') ? null : 'Email is invalid',*/
                      decoration: InputDecoration(
                        labelText: 'Tranmission type',
                        hintText: 'Enter the Tranmission type',
                    ...
                    child: TextFormField(
                     /* initialValue: widget.user.email,
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Enter the Miles Per Gallon',
                    ...
                    child: TextFormField(
                     /* initialValue: widget.user.email,
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Enter your Engine Displacement',
                        icon: Icon(Icons.location_on),
                        isDense: true,
                      ),
                    ),
